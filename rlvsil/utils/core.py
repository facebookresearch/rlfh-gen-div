...
"""
# Code from https://github.com/huggingface/trl/blob/4fe9988eb8adf0227c26432f8eb3e57a66556350/trl/core.py
...
def logprobs_from_logits(logits, labels):
    ...
    # print(f"labels {labels.shape} - {labels.unsqueeze(2).shape}")
...
def normalise_seed(seed: int) -> int:
    """Normalise seed to be in range [0, 2**32-1]."""
    return seed % (2 ** 32 - 1)
